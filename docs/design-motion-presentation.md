...
| S3 | 11 – 17,5 s | La roadmap | La carte s'étire et devient le parcours : en-tête « Vos démarches » + « 2 sur 8 complétées », barre de progression 25 % → 50 %, 4 étapes. « Clôture bancaire » passe **En cours** (pastille et badge violets). | « Votre parcours, dans le bon ordre. » | "Your path, in the right order." |
...
- **S3 — roadmap** : « Vos démarches » / "Your tasks" ; « 2 sur 8 complétées » / "2 of 8 completed" ; étapes : « Acte de décès » (Complété, vert) / "Death certificate" (Completed) ; « Clôture bancaire » (→ En cours, violet) / "Closing bank accounts" (In progress) ; « Caisse de retraite » / "Pension fund" ; « Mutuelle santé » / "Health insurance".
